# -*- coding: utf-8 -*-
"""
Created on Mon Feb 12 20:46:05 2018
...
def data():
    ...
    data = pd.read_csv(r'D:\breast-cancer-wisconsin-data\data.csv', header=0, sep=',')
...
def create_model(X_train, y_train, X_val, y_val):
    ...
    model.add(
        layers.Dense({{choice([np.power(2, 5), np.power(2, 6), np.power(2, 7)])}}, input_shape=(len(data.columns),)))
